...
import {
  ...
  Stock,
  Purchase
} from '../../_components/stocks'

import { z } from 'zod'
import { EventsSkeleton } from '../../_components/stocks/events-skeleton'
import { Events } from '../../_components/stocks/events'
import { StocksSkeleton } from '../../_components/stocks/stocks-skeleton'
import { Stocks } from '../../_components/stocks/stocks'
import { StockSkeleton } from '../../_components/stocks/stock-skeleton'
import {
  formatNumber,
...
import { saveChat } from './appActions'
import { SpinnerMessage, UserMessage } from '../../_components/stocks/message'
...
async function submitUserMessage(content: string) {
  ...
  if(chatbot.defaultMessageMode === 'generated' && aiState.get().messages.length == 0){
    uiProps.prompt = chatbot.defaultPrompt
  }else{
    uiProps.messages = [
...
export const AI = createAI<AIState, UIState>({
  ...
  onSetAIState: async ({ state }) => {
    ...
    // if (session && session.user) {
      ...
      const path = `/chatbots/${chatbotId}/${chatId}`
