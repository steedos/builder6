...
import { IconArrowElbow, IconPlus } from '../_components/ui/icons'
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger
    ...
    >
      <div className="relative flex max-h-60 w-full grow flex-col overflow-hidden bg-background bg-white px-8 sm:rounded-md sm:border sm:px-12">
        ...
        <Textarea
          ...
          className="min-h-[60px] w-full resize-none bg-transparent px-4 py-[1.3rem] focus-within:outline-none sm:text-sm border-0"
          autoFocus
          spellCheck={false}
          autoComplete="off"
          autoCorrect="off"
