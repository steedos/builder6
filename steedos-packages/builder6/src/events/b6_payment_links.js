 ...
 */
module.exports = {
    "@b6_payment_links.inserted": async function (payload, sender, eventName, ctx) {
    ...
    "@b6_payment_links.updated": async function (payload, sender, eventName, ctx) {
        const { objectApiName, id, spaceId, userId, previousDoc } = ctx.params;
        await this.builder6Update(objectApiName, id)
        await this.builder6SpaceUpdate(objectApiName, id)
    },
    "@b6_payment_links.deleted": async function (payload, sender, eventName, ctx) {
        const { objectApiName, id, spaceId, userId, previousDoc } = ctx.params;
