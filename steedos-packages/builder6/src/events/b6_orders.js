 ...
 */
module.exports = {
    "@b6_orders.inserted": async function (payload, sender, eventName, ctx) {
    ...
    "@b6_orders.updated": async function (payload, sender, eventName, ctx) {
        const { objectApiName, id, spaceId, userId, previousDoc } = ctx.params;
        await this.builder6Update(objectApiName, id)
        await this.builder6SpaceUpdate(objectApiName, id)
    },
    "@b6_orders.deleted": async function (payload, sender, eventName, ctx) {
        const { objectApiName, id, spaceId, userId, previousDoc } = ctx.params;
